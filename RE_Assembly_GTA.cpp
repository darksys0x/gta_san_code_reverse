...
// This global variable comes from this scope address BD00F8
// Why do we say this array?
char dword_BD00F8[];
...
void MainClass1::sub_4E2350(int arg1) {
    ...
    if (fun1 == 0) {
        ...
        var3 = var_arg1; // fild [esp+1Ch+arg_0] {this is used to push the value from memory stack to FPU
        ...
        if (var_eax > 0x4) {
            ...
            pointer_ebx->consruct(5, var2, this, var3, /* other args */);
        }
    }
}
